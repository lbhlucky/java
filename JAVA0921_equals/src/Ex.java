public class Ex {
	...
	public static void main(String[] args) {
		...
		// 동등비교연산자(==)를 사용하여 두 객체 비교 시
		// 두 객체가 참조하는 주소값이 같은지 비교
		if(p1 == p2) {
			System.out.println("p1, p2 의 주소값이 같다!");
		} else {
			System.out.println("p1, p2 의 주소값이 다르다!");
		}
		
		// Object 클래스의 equals() 메서드를 사용하여 두 객체가 같은 지 비교
		if(p1.equals(p2)) {			// Object소속임
...
//	
	...
	public boolean equals(Object obj) {
		...
		if (jumin == null) {
			if (other.jumin != null)
				return false;
		} else if (!jumin.equals(other.jumin))		// String 소속임
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
